...
export const Actions: React.FC<ActionsProps> = (props) => {
    ...
    return (
        <div>
            ...
            {openedKebab ? (
                <svg onClick={clickKebabHandler} width="26" height="16" viewBox="0 0 26 6" fill="none">
                ...
                <div className={styles.actions}>
                    <svg onClick={pencilClickHandler} width="26" height="26" viewBox="0 0 19 19" fill="none">
                        <path fillRule="evenodd" clipRule="evenodd"
                    ...
                    <svg onClick={() => DeleteProduct(props.product.id)} width="20" height="26" viewBox="0 0 14 18"
                         fill="none">
                        <path fillRule="evenodd" clipRule="evenodd"
